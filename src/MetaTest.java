...
public class MetaTest {
    public static void main(String[] args) throws Exception {
        ...
        if (newJava.length < initialJava.length + 3) throw new Exception("Meta should create 3 new .java files");
        if (newClass.length < initialClass.length + 3) throw new Exception("Meta should create 3 new .class files");
    ...
    public static File[] numJavaFiles() {
        return new File(".").listFiles(new JavaFileFilter());
    }
    public static File[] numClassFiles() {
        return new File(".").listFiles(new ClassFileFilter());
    }
    public static List<File> diff(File[] a, File[] b) {
